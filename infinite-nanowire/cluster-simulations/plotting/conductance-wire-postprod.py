...
#%% Loading data
file_list = ['final-data.h5']
data_dict = load_my_data(file_list, '/home/mfmm/Projects/amorphous-nanowires/data/data-cluster/final-data-conductance-wire.h5')
