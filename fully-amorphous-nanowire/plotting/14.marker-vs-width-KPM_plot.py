...
#%% Loading data
file_list = ['data-cluster-marker-KPM-N=8-2.h5']
...
# Simulation data
L            = data_dict[file_list[0]]['Simulation']['L']
...
# Parameters
N            = data_dict[file_list[0]]['Parameters']['N']
...
fontsize = 20
palette = seaborn.color_palette(palette='magma_r', n_colors=len(L))
...
for i in range(0, len(L)):
    ax1.plot(width, avg_marker[i, :], marker='o', linestyle='solid', color=palette[i], label=f'${L[i]}$')
