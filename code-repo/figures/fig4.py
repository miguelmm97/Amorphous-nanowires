...
bulk_tot_density = data_dict[file_list[1]]['Simulation']['bulk_tot_density']
DoS_top          = data_dict[file_list[1]]['Simulation']['DoS_top']
DoS_loc          = data_dict[file_list[1]]['Simulation']['DoS_loc']
DoS_bound        = data_dict[file_list[1]]['Simulation']['DoS_bound']
cuts_top         = data_dict[file_list[1]]['Simulation']['cuts_top']
cuts_loc         = data_dict[file_list[1]]['Simulation']['cuts_loc']
cuts_bound       = data_dict[file_list[1]]['Simulation']['cuts_bound']
N                = data_dict[file_list[1]]['Simulation']['N']
nx               = data_dict[file_list[1]]['Simulation']['nx']
...
fig1.savefig('fig4.pdf', format='pdf')
plt.show()
